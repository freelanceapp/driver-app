...
public class MainActivity extends BaseActivity implements Apis,
    ...
    com.apporio.demotaxiappdriver.samwork.ApiManager apiManager_new ;
    ...
    private void menuListeners() {
        ...
        findViewById(R.id.my_earnings_menu_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, com.apporio.demotaxiappdriver.earnings.EarningActivity.class));
            }
        });
