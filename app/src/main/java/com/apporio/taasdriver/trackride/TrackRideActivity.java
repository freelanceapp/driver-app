...
import com.apporio.taasdriver.ChatActivity;
import com.apporio.taasdriver.Config;
import com.apporio.taasdriver.LocationEvent;
import com.apporio.taasdriver.LocationSession;
import com.apporio.taasdriver.PriceFareActivity;
import com.apporio.taasdriver.R;
import com.apporio.taasdriver.RideSessionActiveRideEvent;
import com.apporio.taasdriver.SelectedRidesActivity;
import com.apporio.taasdriver.SosActivity;
import com.apporio.taasdriver.SplashActivity;
import com.apporio.taasdriver.TripHistoryActivity;
import com.apporio.taasdriver.adapter.ReasonAdapter;
...
import com.apporio.taasdriver.models.ResultCheck;
import com.apporio.taasdriver.models.cancelreasoncustomer.CancelReasonCustomer;
import com.apporio.taasdriver.models.restmodels.NewChangeDropLocationModel;
import com.apporio.taasdriver.models.restmodels.NewUpdateLatLongModel;
import com.apporio.taasdriver.models.ridearrived.RideArrived;
import com.apporio.taasdriver.models.viewrideinfodriver.ViewRideInfoDriver;
import com.apporio.taasdriver.others.ChatModel;
import com.apporio.taasdriver.others.Constants;
import com.apporio.taasdriver.others.FirebaseChatEvent;
import com.apporio.taasdriver.others.FirebaseChatUtillistener;
import com.apporio.taasdriver.others.Maputils;
import com.apporio.taasdriver.others.RideSessionEvent;
import com.apporio.taasdriver.routedrawer.DrawMarker;
import com.apporio.taasdriver.routedrawer.DrawRouteMaps;
import com.apporio.taasdriver.samwork.ApiManager;
import com.apporio.taasdriver.urls.Apis;
import com.apporio.taasdriver.views.MButton;
import com.apporio.taasdriver.views.MaterialRippleLayout;
...
//        trip_status_txt.setTextSize(15);
        ...
        findViewById(R.id.location_changer1).setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onClick(View view) {
                ...
                new SamLocationRequestService(TrackRideActivity.this).executeService(new SamLocationRequestService.SamLocationListener() {
                    ...
                    public void onLocationUpdate(Location location) {
                        ...
                        mGooglemap.animateCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition.Builder().target(mlat).zoom(Config.MainScrenZoon).build()));
