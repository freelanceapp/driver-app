...
import com.apporio.taasdriver.manager.DeviceManager;
...
import com.apporio.taasdriver.models.ActiveRidesResponse;
import com.apporio.taasdriver.models.CallSupportResponse;
import com.apporio.taasdriver.models.ModelReportIssue;
import com.apporio.taasdriver.models.ModelScheduleAndunacceptedRide;
import com.apporio.taasdriver.models.ResultCheck;
import com.apporio.taasdriver.models.deviceid.DeviceId;
import com.apporio.taasdriver.models.restmodels.NewHeatmapModel;
...
import com.apporio.taasdriver.settings.SettingsActivity;
...
public class MainActivity extends BaseActivity implements Apis,
    ...
    com.apporio.taasdriver.samwork.ApiManager apiManager_new;
    ...
    private void menuListeners() {
        ...
        findViewById(R.id.my_earnings_menu_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, com.apporio.taasdriver.earnings.EarningActivity.class));
            }
        });
