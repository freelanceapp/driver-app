...
public class RidesActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ridesActivity = this;
        setContentView(com.taas.driver.R.layout.activity_rides);
        getSupportActionBar().hide();
        ll_back_rides = (LinearLayout) findViewById(com.taas.driver.R.id.ll_back_rides);
        progressBar = (ProgressBar) findViewById(com.taas.driver.R.id.progress_wheel);
        place_holder = (PlaceHolderView) findViewById(com.taas.driver.R.id.place_holder);
