...
public class SelectedRidesActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.taas.driver.R.id.ll_back_ride_select) LinearLayout llBackRideSelect;
    @Bind(com.taas.driver.R.id.ll_driver_ki_detail) LinearLayout llDriverKiDetail;
    @Bind(com.taas.driver.R.id.ll_bill) LinearLayout llBill;
    @Bind(com.taas.driver.R.id.ll_location_module) LinearLayout llLocationModule;
    @Bind(com.taas.driver.R.id.ll_total_bill) LinearLayout llTotalBill;
    @Bind(com.taas.driver.R.id.ll_track_ride) LinearLayout llTrackRide;
    @Bind(com.taas.driver.R.id.activity_selected_rides) LinearLayout activitySelectedRides;
    @Bind(com.taas.driver.R.id.bill_layout) LinearLayout bill_layout;
    @Bind(com.taas.driver.R.id.tv_rupee) TextView tvRupee;
    @Bind(com.taas.driver.R.id.tv_dis) TextView tvDis;
    @Bind(com.taas.driver.R.id.tv_time1) TextView tvTime1;
    @Bind(com.taas.driver.R.id.start_time_txt) TextView startTimeTxt;
    @Bind(com.taas.driver.R.id.tv_start_location) TextView tvStartLocation;
    @Bind(com.taas.driver.R.id.drop_time_txt) TextView dropTimeTxt;
    @Bind(com.taas.driver.R.id.tv_end_location) TextView tvEndLocation;
    @Bind(com.taas.driver.R.id.total_distance_txt) TextView totalDistanceTxt;
    @Bind(com.taas.driver.R.id.total_fare_txt) TextView totalFareTxt;
    @Bind(com.taas.driver.R.id.ride_time_charges_txt) TextView rideTimeChargesTxt;
    @Bind(com.taas.driver.R.id.wating_charge_txt) TextView watingChargeTxt;
    @Bind(com.taas.driver.R.id.coupon_code_txt) TextView couponCodeTxt;
    @Bind(com.taas.driver.R.id.coupon_value_txt) TextView couponValueTxt;
    @Bind(com.taas.driver.R.id.total_gross_bill_txt) TextView totalGrossBillTxt;
    @Bind(com.taas.driver.R.id.payment_mode_txt) TextView paymentModeTxt;
    @Bind(com.taas.driver.R.id.payment_amount_done_txt) TextView paymentAmountDoneTxt;
    @Bind(com.taas.driver.R.id.tv_date_time1)
    TypeFaceTextMeseoSemiBold tvDateTime1;
    @Bind(com.taas.driver.R.id.customer_name_txt) TextView customer_name_txt;
    @Bind(com.taas.driver.R.id.customer_phone_txt) TextView customer_phone_txt;
    @Bind(com.taas.driver.R.id.iv_image_driver) CircleImageView ivImageDriver;


    @Bind(com.taas.driver.R.id.night_time_charge_txt) TextView night_time_charge_txt;

    @Bind(com.taas.driver.R.id.peak__charge_txt) TextView peak__charge_txt;
    @Bind(com.taas.driver.R.id.rating_selected)
    RatingBar ratingBar;
    @Bind(com.taas.driver.R.id.wallet_amount_done_txt)
    TextView wallet_amount_done_txt;
    @Bind(com.taas.driver.R.id.cash_amount_done_txt)
    TextView cash_amount_done_txt;
    @Bind(com.taas.driver.R.id.cash_mode_txt)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_selected_rides);
...
//        setViewVisibility(""+super.getIntent().getExtras().getString("ride_status"));
        ...
        if(ride_status.equals("1")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__new_ride_allocated);
        } if(ride_status.equals("2")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__user_cancelled_ride);
        } if(ride_status.equals("3")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__accepted);
        } if(ride_status.equals("4")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__alloting_to_other);
        } if(ride_status.equals("5")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__arrived);
        } if(ride_status.equals("6")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__ride_on_going);
        } if(ride_status.equals("7")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__ride_completed);
        } if(ride_status.equals("8")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__later_request);
        } if(ride_status.equals("9")){
            tvDateTime1.setText(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__cancelled_by_you);
        }
        ...
        findViewById(com.taas.driver.R.id.ll_back_ride_select).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(com.taas.driver.R.id.ll_track_ride).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            ...
            if (APINAME.equals(""+Config.ApiKeys.KEY_VIEW_RIDE_INFO_DRIVER)) {
                ...
                if (viewRideInfoDriver.getResult() == 1 ) {
                    ...
                    if(viewRideInfoDriver.getDetails().getPayment_option_id().equals("4")){
                        cash_mode_txt.setText(getResources().getString(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__cash));
                    }
                    else {
                    ...
                    if(viewRideInfoDriver.getDetails().getCoupons_price().equals("")){
                        ...
                        couponCodeTxt.setText(SelectedRidesActivity.this.getResources().getString(com.taas.driver.R.string.SELECTED_RIDE_ACTIVITY__coupon_applied)+" ("+viewRideInfoDriver.getDetails().getCoupon_code()+")");
                    ...
                    Toast.makeText(SelectedRidesActivity.this, "" + this.getResources().getString(com.taas.driver.R.string.ride_selected_no_data_found), Toast.LENGTH_SHORT).show();
                }
            }}catch (Exception e){}
