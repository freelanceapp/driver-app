...
import com.taas.driver.models.DocumentListModel;
...
/*
        ...
        findViewById(com.taas.driver.R.id.submit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        try{ if (APINAME.equals("document_list")) {
            try {
                ...
                if (rs.result.equals("1")) {
                    ...
                    Toast.makeText(this, com.taas.driver.R.string.no_doc_found_inthis_city, Toast.LENGTH_LONG).show();
                }
            } catch (Exception e) {
           ...
           //     LoginResponse loginResponse;
                ...
                if (detail_status.equals("1")) {
                    Toast.makeText(this, com.taas.driver.R.string.please_upload_all_documents, Toast.LENGTH_SHORT).show();
    ...
    @Layout(com.taas.driver.R.layout.item_document_list)
    private class HolderDocumentItem {

        @com.sam.placer.annotations.View(com.taas.driver.R.id.document_name_txt) private TextView document_name_txt;
        @com.sam.placer.annotations.View(com.taas.driver.R.id.document_status_txt) private TextView document_status_txt;
