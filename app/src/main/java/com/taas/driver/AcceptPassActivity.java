...
import com.taas.driver.models.ModelCheckTime;
import com.taas.driver.models.ModelPartialRequestResponse;
import com.taas.driver.models.restmodels.NewRideAcceptmodel;
...
public class AcceptPassActivity extends Activity implements ApiManager.APIFETCHER {
   ...
   // FirebaseUtils firebaseUtils;
    ...
    RelativeLayout back;
    @Bind(com.taas.driver.R.id.activity_name_txt)
    TypefaceDosisRegular activityNameTxt;
    @Bind(com.taas.driver.R.id.user_image)
    ...
    @Bind(com.taas.driver.R.id.booking_date_txt)
    TextView booking_date_txt;
    @Bind(com.taas.driver.R.id.requested_date_txt)
    ...
    @Bind(com.taas.driver.R.id.request_type)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_accept_pass);
        ...
        if (RIDE_TYPE.equals("1")) {
            requestType.setText(com.taas.driver.R.string.normal_type);
        } else if (RIDE_TYPE.equals("2")) {
            requestType.setText(com.taas.driver.R.string.rental_request);
        }
        try {
    ...
    protected void onResume() {
        ...
        if (RIDE_STATUS.equals("22")) {
            ...
            loadingText.setText(AcceptPassActivity.this.getResources().getString(com.taas.driver.R.string.accept));
        }
    }
            ...
            switch (APINAME) {
                case Config.ApiKeys.CHECK_RIDE_TIME:
                    ...
                    if (modelCheckTime.getResult() == 0) {
                        ...
                        loadingText.setText(AcceptPassActivity.this.getResources().getString(com.taas.driver.R.string.start_for_customer_pickup));
                    }
                    break;
                ...
                case Config.ApiKeys.KEY_ACEPT_RIDE:
                    ...
                    if (ac.getResult() == 1) {
                        ...
                        Toast.makeText(this, com.taas.driver.R.string.your_ride_is_expired, Toast.LENGTH_SHORT).show();
                    }
                    break;
