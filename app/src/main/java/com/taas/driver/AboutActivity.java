...
import com.taas.driver.models.AboutResponse;
...
public class AboutActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_about);
        getSupportActionBar().hide();
        about = this;
        apiManager = new ApiManager(this);

        ll_back_about = (LinearLayout) findViewById(com.taas.driver.R.id.ll_back_about);
        tv_about = (TextView) findViewById(com.taas.driver.R.id.tv_about);
        tv_version = (TextView) findViewById(com.taas.driver.R.id.tv_version);
        ...
        tv_version.setText(AboutActivity.this.getResources().getString(com.taas.driver.R.string.version) + version1);
    ...
    private class ImageGetter implements Html.ImageGetter {
        ...
        public Drawable getDrawable(String source) {
            ...
            if (source.equals("hughjackman.jpg")) {
                id = com.taas.driver.R.drawable.app_logo_100;
            }
            else {
                return null;
            }
