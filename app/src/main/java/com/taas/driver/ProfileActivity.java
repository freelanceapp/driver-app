   ...
   // FirebaseUtils firebasutil ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // firebasutil = new FirebaseUtils(this);
        setContentView(com.taas.driver.R.layout.activity_profile);
        getSupportActionBar().hide();
        profileActivity = this;

        apiManager = new ApiManager(this);
        pd = new ProgressDialog(this);
        pd.setMessage(ProfileActivity.this.getResources().getString(com.taas.driver.R.string.loading));
        ...
        account_name = (EditText) findViewById(com.taas.driver.R.id.account_name);
        name = (EditText) findViewById(com.taas.driver.R.id.name);
        mobile = (EditText) findViewById(com.taas.driver.R.id.mob);

        name.setEnabled(false);
        mobile.setEnabled(false);

        email = (TextView) findViewById(com.taas.driver.R.id.email);
        bank_name = (EditText) findViewById(com.taas.driver.R.id.bank_name);
        account_number = (EditText) findViewById(com.taas.driver.R.id.account_number);
        iv_edit_name = (ImageView) findViewById(com.taas.driver.R.id.iv_edit_name);
...
//        });
        ll_done_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name1.equals("")) {
                    Toast.makeText(ProfileActivity.this, ProfileActivity.this.getResources().getString(com.taas.driver.R.string.name_can_not_be_empty), Toast.LENGTH_SHORT).show();
                } else if (mobile1.equals("")) {
                    Toast.makeText(ProfileActivity.this, ProfileActivity.this.getResources().getString(com.taas.driver.R.string.phone_can_not_be_empty), Toast.LENGTH_SHORT).show();
                } else if (bank_name1.equals("")) {
                    Toast.makeText(ProfileActivity.this, ProfileActivity.this.getResources().getString(com.taas.driver.R.string.bank_name_empty), Toast.LENGTH_SHORT).show();
                } else if (account_name1.equals("")) {
                    Toast.makeText(ProfileActivity.this, ProfileActivity.this.getResources().getString(com.taas.driver.R.string.account_name_empty), Toast.LENGTH_SHORT).show();
                } else if (account_number1.equals("")) {
                    Toast.makeText(ProfileActivity.this, ProfileActivity.this.getResources().getString(com.taas.driver.R.string.account_number_empty), Toast.LENGTH_SHORT).show();
                } else {
         ...
         findViewById(com.taas.driver.R.id.accuracy_save).setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
        ...
        findViewById(com.taas.driver.R.id.meter_range_save_btn).setOnClickListener(new View.OnClickListener() {   // this functionality is only for development purpose
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.taas.driver.R.id.info).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                dialog.setContentView(com.taas.driver.R.layout.info_dialog);
                dialog.findViewById(com.taas.driver.R.id.ok_btn).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        dialog.dismiss();
                    }
    ...
    public void showlogoutdialog() {
        ...
        window.setGravity(Gravity.CENTER);
        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(com.taas.driver.R.layout.dialog_for_logout);

        LinearLayout yes = (LinearLayout) dialog.findViewById(com.taas.driver.R.id.yes);
        LinearLayout no = (LinearLayout) dialog.findViewById(com.taas.driver.R.id.no);
    ...
    public void onFetchComplete(Object script, String APINAME) {
        ...
        if (APINAME.equals("Edit Profile")) {
            ...
            if (register.getResult() == 1) {
                ...
                dialog.setCancelable(false);
                dialog.setContentView(com.taas.driver.R.layout.layout_profile_update);
               Button closeBTn = (Button) dialog.findViewById(com.taas.driver.R.id.close_btn);
