...
public class WeeklyStatementActivity extends Activity implements ApiManager.APIFETCHER {
    ...
    TextView totalEarningTV, completedTripsTV, fareEarnedTV, taxiFeeTV, bonusTV, textView4, startDate,endDate;
    String driver_id;
    ProgressDialog pd;
                ...
                try {
                    ...
                    if (weeklyEarningModel.getResult() == 1) {
                        ...
                        for (int i = 0; i < weeklyEarningModel.getDetails().size(); i++) {
                            ...
                            try {
                                String start_date = ""+weeklyEarningModel.getDetails().get(0).getDate() ;
                                String end_date = ""+ weeklyEarningModel.getDetails().get(weeklyEarningModel.getDetails().size() - 1).getDate();

                                startDate.setText(start_date);  endDate.setText(end_date);
