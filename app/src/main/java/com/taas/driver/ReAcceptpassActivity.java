...
public class ReAcceptpassActivity extends Activity implements ApiManager.APIFETCHER {
   ...
   // FirebaseUtils firebaseUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_re_acceptpass);
    ...
    public void onFetchComplete(Object script, String APINAME) {
        try {
            if (APINAME.equals("" + Config.ApiKeys.KEY_VIEW_RIDE_INFO_DRIVER)) {
                ...
                Glide.with(this).load("" + Apis.googleImage + "" + viewRideInfoDriver.getDetails().getPickup_lat() + "," + viewRideInfoDriver.getDetails().getPickup_long() + "&zoom=15&size=400x400&key=" + ReAcceptpassActivity.this.getResources().getString(com.taas.driver.R.string.google_map_key)).into(mapImage);
