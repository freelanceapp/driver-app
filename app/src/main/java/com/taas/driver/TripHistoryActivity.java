...
public class TripHistoryActivity extends BaseActivity implements ApiManager.APIFETCHER {
    ...
    ImageView back;
    @Bind(com.taas.driver.R.id.root_action_bar)
    LinearLayout rootActionBar;
    @Bind(com.taas.driver.R.id.viewpagertab)
    SmartTabLayout viewpagertab;
    @Bind(com.taas.driver.R.id.container)
    ViewPager container;
    @Bind(com.taas.driver.R.id.activity_name)
    TextView activityName;
    @Bind(com.taas.driver.R.id.refresh)
    ImageView refresh;
    @Bind(com.taas.driver.R.id.root)
    LinearLayout root;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_trip_history);
    ...
    public static class ActiveRideFragment extends Fragment {
        ...
        @Bind(com.taas.driver.R.id.place_holder)
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View rootView = inflater.inflate(com.taas.driver.R.layout.active_ride_fragment, container, false);
    ...
    public static class NewRequestFragment extends Fragment {
        ...
        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View rootView = inflater.inflate(com.taas.driver.R.layout.new_request_fragments, container, false);
            ButterKnife.bind(this, rootView);
...
//            fragment.setArguments(args);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(com.taas.driver.R.layout.history_fragment, container, false);
            ButterKnife.bind(this, rootView);
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        String[] fragmens_name = {getString(com.taas.driver.R.string.on__going),getString(com.taas.driver.R.string.past_trips)};
    ...
    @Layout(com.taas.driver.R.layout.rides_item_new)
    public static class HolderRideHistoryNormal {
        @com.sam.placer.annotations.View(com.taas.driver.R.id.tv_date_time)
        private TextView tv_date_time;

        @com.sam.placer.annotations.View(com.taas.driver.R.id.tv_amount)
        private TextView tv_amount;

        @com.sam.placer.annotations.View(com.taas.driver.R.id.tv_time)
            TextView tv_time;
        @com.sam.placer.annotations.View(com.taas.driver.R.id.tv_pickup_addresss)
        private TextView tv_pickup_addresss;
        @com.sam.placer.annotations.View(com.taas.driver.R.id.tv_drop_addresss)
        private TextView tv_drop_addresss;
        @com.sam.placer.annotations.View(com.taas.driver.R.id.customer_name_txt)
        private TextView customer_name_txt;
        @com.sam.placer.annotations.View(com.taas.driver.R.id.customer_phone_txt)
    ...
    @Layout(com.taas.driver.R.layout.ride_history_rental_item)
    ...
    @Layout(com.taas.driver.R.layout.item_new_request_normal)
    public static class HolderNewRequestNormal {
        ...
        private void onResolved() {
            ...
            customer_name_txt.setText("" + mNormalRideResponse.getUser_name());
            customer_phone_txt.setText("" + mNormalRideResponse.getUser_phone());
            tv_status.setText(com.taas.driver.R.string.accept_pass);
        }
    ...
    @Layout(com.taas.driver.R.layout.item_new_request_rental)
    ...
    @Layout(com.taas.driver.R.layout.no_rides_holder)
