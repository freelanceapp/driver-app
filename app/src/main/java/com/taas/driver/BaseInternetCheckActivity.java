...
import com.taas.driver.others.EventLocatoin;
import com.taas.driver.others.InternetEvent;
...
public class BaseInternetCheckActivity extends BaseStatusActivity {
    ...
    public void onMessageEvent(InternetEvent event) {
        if(appMsg == null ){
            appMsg = AppMsg.makeText(this , getString(com.taas.driver.R.string.no_internet_connection) , new AppMsg.Style(AppMsg.LENGTH_STICKY , com.taas.driver.R.color.colorPrimary));
