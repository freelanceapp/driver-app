...
public class ChatActivity extends Activity {
    ...
    ListView list;
    @Bind(com.taas.driver.R.id.message_edt)
    EditText messageEdt;
    @Bind(com.taas.driver.R.id.send_btn)
    ...
    @Bind(com.taas.driver.R.id.user_name_txt)
    TextView userNameTxt;
    @Bind(com.taas.driver.R.id.riding_status)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_chat);
        activity = this ;
        try {
        ...
        try{ ridingStatus.setText(""+getIntent().getExtras().getString("ride_status"));
            ...
            Glide.with(this).load("" + getIntent().getExtras().getString("user_image")).placeholder(com.taas.driver.R.drawable.ic_profile_small).into(userImage);}catch (Exception e){}
    ...
    private class ChatAdapter extends BaseAdapter {
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                ...
                holder.right_date = (ZamanTextView) convertView.findViewById(com.taas.driver.R.id.right_date);
