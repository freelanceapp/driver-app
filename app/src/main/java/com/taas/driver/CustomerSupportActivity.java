...
public class CustomerSupportActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_dialoge.setMessage(""+this.getResources().getString(com.taas.driver.R.string.loading));
        apiManager = new ApiManager(this);
        super.onCreate(savedInstanceState);
        setContentView(com.taas.driver.R.layout.activity_customer_support);
        ButterKnife.bind(this);
        getSupportActionBar().hide();


        findViewById(com.taas.driver.R.id.ll_back_about).setOnClickListener(new View.OnClickListener() {
            @Override
...
//                if(user_name_edt.getText().toString().equals("")  || email_edt.getText().toString().equals("") || query_edt.getText().toString().equals("") ){
    ...
    public void dialogForQueryComplete(String message ) {
        ...
        dialog.setContentView(com.taas.driver.R.layout.dialog_for_query_complete);
        dialog.setCancelable(false);
        TextView quer_response_message  = (TextView) dialog.findViewById(com.taas.driver.R.id.quer_response_message);
        quer_response_message.setText(""+message);

        LinearLayout ll_update = (LinearLayout) dialog.findViewById(com.taas.driver.R.id.ll_ok);
