...
import com.taas.driver.models.restmodels.NewRideRejectModel;
...
public class ReceiveRentalPassengerActivity extends Activity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.taas.driver.R.id.eta_price_txt)
    TextView etaPriceTxt;
    @Bind(com.taas.driver.R.id.pickup_address_txt)
    TextView pickupAddressTxt;
    @Bind(com.taas.driver.R.id.accept_btn)
    LinearLayout acceptBtn;
    @Bind(com.taas.driver.R.id.reject_btn)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_layout = (LinearLayout) findViewById(com.taas.driver.R.id.card_layout);
        cash_layout = (LinearLayout) findViewById(com.taas.driver.R.id.cash_layout);
            ...
            switch (APINAME) {
                case Config.ApiKeys.KEY_REST_RIDE_INFO:
                    ...
                    if (rs.getStatus() == 1) {
                        ...
                        Glide.with(this).load("" + Apis.googleImage + "" + response.getDetails().getPickup_lat() + "," + response.getDetails().getPickup_long() + "&zoom=15&size=400x400&key=" + ReceiveRentalPassengerActivity.this.getResources().getString(com.taas.driver.R.string.google_map_key)).into(mapImage);
