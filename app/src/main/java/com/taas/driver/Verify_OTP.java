...
import com.taas.driver.models.newdriveraccount.RegistrationModel;
...
public class Verify_OTP extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otp_input = (EditText)findViewById(com.taas.driver.R.id.edit_verify_otp);
        submit_otp_layout = (LinearLayout)findViewById(com.taas.driver.R.id.otp_register);
        ...
        submit_otp_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input_OTP.equals("")) {
                     Toast.makeText(Verify_OTP.this, com.taas.driver.R.string.required_field_empty, Toast.LENGTH_SHORT).show();
                 }else if (!otp_input.getText().toString().equals(otp)) {
                     Toast.makeText(Verify_OTP.this, com.taas.driver.R.string.invalid_otp, Toast.LENGTH_SHORT).show();
                }else {
