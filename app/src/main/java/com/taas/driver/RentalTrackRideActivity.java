...
import com.taas.driver.models.restmodels.NewEndRideModel;
import com.taas.driver.models.restmodels.NewRideArrivedModel;
import com.taas.driver.models.restmodels.NewbeginTripModel;
...
public class RentalTrackRideActivity extends AppCompatActivity implements OnMapReadyCallback, ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_track_ride_rental);
        ...
        findViewById(com.taas.driver.R.id.call_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//    }
    ...
    private void showDialogForCancelation() {
        ...
        dialog.setContentView(com.taas.driver.R.layout.dialog_for_cancel_via_customer);
    ...
    private void showDialogForCancelationByAdmin() {
        ...
        window.setGravity(Gravity.CENTER);
        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(com.taas.driver.R.layout.dialog_for_cancel_via_admin);
        dialog.findViewById(com.taas.driver.R.id.ok).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void setviewAccordingToStatus() {
        ...
        if (rideSession.getCurrentRideDetails().get(RideSession.RIDE_STATUS).equals("12")) {
            cancel_btn.setVisibility(View.VISIBLE);
            trip_status_txt.setText("" + this.getResources().getString(com.taas.driver.R.string.TRACK_RIDE_RENTAL_ACTIVITY__begin));
            mGooglemap.clear();
        ...
        if (rideSession.getCurrentRideDetails().get(RideSession.RIDE_STATUS).equals("13")) {
            ...
            trip_status_txt.setText("" + this.getResources().getString(com.taas.driver.R.string.TRACK_RIDE_RENTAL_ACTIVITY__end));
...
//        DrawMarker.getInstance(this).draw(mMap, destination, destination_icon, ""+rideSession.getCurrentRideDetails().get(RideSession.DROP_LOCATION));
    ...
    public void onFetchComplete(Object script, String APINAME) {
        try {
            ...
            if (rs.getStatus() == 1) {
                ...
                Toast.makeText(this, com.taas.driver.R.string.TRACK_RIDE_RENTAL_ACTIVITY__something_bad_happen_with_api, Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
        }
    ...
    public void showReasonDialog(final CancelReasonCustomer cancelReasonCustomer) {
        ...
        window.setGravity(Gravity.CENTER);
        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(com.taas.driver.R.layout.dialog_for_cancel_reason);

        ListView lv_reasons = (ListView) dialog.findViewById(com.taas.driver.R.id.lv_reasons);
