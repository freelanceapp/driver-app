...
public class PhotoUploaderActivity extends Activity implements EasyPermissions.PermissionCallbacks , DatePickerDialog.OnDateSetListener , ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_photo_uploader);
            ...
            public void onClick(View view) {
                try{
                    if(date.getText().toString().equals("DD MM YYYY")){
                        Toast.makeText(PhotoUploaderActivity.this, com.taas.driver.R.string.attach_expirey_date_of_your_document, Toast.LENGTH_SHORT).show();
                    }else{
...
//                    Toast.makeText(this, ""+e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void openDateFDialog() throws Exception{
        ...
        dpd.setAccentColor(PhotoUploaderActivity.this.getResources().getColor(com.taas.driver.R.color.colorPrimary));
