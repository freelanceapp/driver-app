...
public class ManualUserDetailActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.taas.driver.R.id.ll_back_rides)
    LinearLayout ll_back_rides;

    @Bind(com.taas.driver.R.id.textView_dropPoint)
    TextView textView_dropPoint;

    @Bind(com.taas.driver.R.id.ll_dropLocation)
    LinearLayout ll_dropLocation;

    @Bind(com.taas.driver.R.id.textView_pickUp)
    TextView textView_pickUp;

    @Bind(com.taas.driver.R.id.ll_pickUpLocation)
    LinearLayout ll_pickUpLocation;

    @Bind(com.taas.driver.R.id.edt_cus_number)
    EditText edt_cus_number;

    @Bind(com.taas.driver.R.id.edt_cus_name)
    EditText edt_cus_name;

    @Bind(com.taas.driver.R.id.btnStartRide)
    Button btnStartRide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_manual_user_detail);
    ...
    private void initialization() {
        ...
        button_startRide = ((MaterialRippleLayout) findViewById(com.taas.driver.R.id.button_startRide)).getChildView();
        countryCodePicker = (CountryCodePicker) findViewById(com.taas.driver.R.id.otp_ccp);
        button_startRide.setText(getResources().getString(com.taas.driver.R.string.Manual_Activity_button_start_ride));
        ...
        public void onClick(View view) {
            ...
            if (i == btnStartRide.getId()) {
                if (textView_pickUp.getText().toString().equals("")) {
                    Toast.makeText(ManualUserDetailActivity.this, getResources().getString(com.taas.driver.R.string.Manual_Activity_select_pick_location), Toast.LENGTH_SHORT).show();
                    ManualUserDetailActivity.this.finish();
                } else if (manualDropLat.equals("") && manualDropLng.equals("")) {
                    Toast.makeText(ManualUserDetailActivity.this, getResources().getString(com.taas.driver.R.string.Manual_Activity_select_drop_location), Toast.LENGTH_SHORT).show();
                } else {
                    startRideMethod();
                }
