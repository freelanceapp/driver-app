...
public class MeterImageActivity extends Activity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_meter_image);
        image = (ImageView) findViewById(com.taas.driver.R.id.image);
        meter_val_edt = (EditText) findViewById(com.taas.driver.R.id.meter_val_edt);

        imagePathCompressed = "";

        findViewById(com.taas.driver.R.id.image).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(com.taas.driver.R.id.ok_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (imagePathCompressed.equals("") || meter_val_edt.getText().toString().equals("")){
                    Toast.makeText(MeterImageActivity.this, com.taas.driver.R.string.METER_IMAGE_ACTIVITY__current_meter_reading_txt, Toast.LENGTH_SHORT).show();
                }else {
                    finalizeActivity();
                }
            }
    ...
    public void cameraTask() {
        if (EasyPermissions.hasPermissions(this, Manifest.permission.CAMERA)) {
            ...
            EasyPermissions.requestPermissions(this, getString(com.taas.driver.R.string.rationale_camera), RC_CAMERA_PERM, Manifest.permission.CAMERA);
        }
    }
