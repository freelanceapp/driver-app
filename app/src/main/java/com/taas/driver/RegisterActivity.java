...
import com.taas.driver.adapter.CarAdapter;
import com.taas.driver.adapter.CarModelAdapter;
import com.taas.driver.adapter.CityAdapter;
import com.taas.driver.manager.LanguageManager;
import com.taas.driver.models.ResultCheck;
import com.taas.driver.models.carmodels.CarModels;
import com.taas.driver.models.register.Register;
import com.taas.driver.models.viewcartype.ViewCarType;
import com.taas.driver.models.viewcity.ViewCity;
...
public class RegisterActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gson = builder.create();
        setContentView(com.taas.driver.R.layout.activity_register);
        ...
        pd.setMessage(RegisterActivity.this.getResources().getString(com.taas.driver.R.string.loading));
        pd.setCancelable(false);
        pd.setCanceledOnTouchOutside(false);

        tv_ride_category = (TextView) findViewById(com.taas.driver.R.id.tv_ride_category);

        driver_image = (ImageView) findViewById(com.taas.driver.R.id.driver_image);
        tv_city = (TextView) findViewById(com.taas.driver.R.id.tv_city);
        tv_car_type = (TextView) findViewById(com.taas.driver.R.id.tv_car_type);
        tv_car_model = (TextView) findViewById(com.taas.driver.R.id.tv_car_model);

        edt_username_signup = (EditText) findViewById(com.taas.driver.R.id.edt_username_signup);
        edt_email_signup = (EditText) findViewById(com.taas.driver.R.id.edt_email_signup);
        edt_pass_signup = (EditText) findViewById(com.taas.driver.R.id.edt_pass_signup);
        tv_city_two = (TextView) findViewById(com.taas.driver.R.id.tv_city_two);
        txt_phone_signup = (TextView) findViewById(com.taas.driver.R.id.txt_phone_signup);

        edt_car_number = (EditText) findViewById(com.taas.driver.R.id.edt_car_number);
        ll_register = (LinearLayout) findViewById(com.taas.driver.R.id.ll_register);
        ll_back_signup = (LinearLayout) findViewById(com.taas.driver.R.id.ll_back_signup);
        ...
        tv_city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cityCheck.equals("1")) {
                    ...
                    dialog.setContentView(com.taas.driver.R.layout.dialog_for_city);

                    ListView lv_cities = (ListView) dialog.findViewById(com.taas.driver.R.id.lv_cities);
                    ...
                    lv_cities.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            tv_car_type.setText(getResources().getString(com.taas.driver.R.string.REGISTER_ACTIVITY__select_car_type));
                            car_id ="";
                    ...
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.no_city_found), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        driver_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle(com.taas.driver.R.string.upload_profile_pic);
                builder.setItems(new String[]{getString(com.taas.driver.R.string.camera), getString(com.taas.driver.R.string.gallery)}, new DialogInterface.OnClickListener() {
                    @Override
        ...
        tv_ride_category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*if (tv_ride_category.getText().toString().equals("Type of Ride")) {
                    ...
                    Window window = dialog.getWindow();
                    window.setGravity(Gravity.CENTER);
                    dialog.setContentView(com.taas.driver.R.layout.dialog_driver_category);

                    ListView lv_category = (ListView) dialog.findViewById(com.taas.driver.R.id.lv_category);
        ...
        tv_car_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tv_city.getText().toString().equals("Select City")) {
                    Toast.makeText(RegisterActivity.this,  RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_select_city), Toast.LENGTH_SHORT).show();
                } else if (carTypeCheck.equals("1")) {
                    final Dialog dialog = new Dialog(RegisterActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
                    dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    Window window = dialog.getWindow();
                    window.setGravity(Gravity.CENTER);
                    dialog.setContentView(com.taas.driver.R.layout.dialog_for_car);

                    ListView lv_cars = (ListView) dialog.findViewById(com.taas.driver.R.id.lv_cars);
                    ...
                    lv_cars.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            tv_car_model.setText(getResources().getString(com.taas.driver.R.string.REGISTER_ACTIVITY__select_car_model));
                            car_model_id = "";
                    ...
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.no_car_found), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        tv_car_model.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tv_car_type.getText().toString().equals("Select Car Type")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_select_car_type_first), Toast.LENGTH_SHORT).show();
                } else if (carNameCheck.equals("1")) {
                    final Dialog dialog = new Dialog(RegisterActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
                    dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    Window window = dialog.getWindow();
                    window.setGravity(Gravity.CENTER);
                    dialog.setContentView(com.taas.driver.R.layout.dialog_for_car_model);

                    ListView lv_cars = (ListView) dialog.findViewById(com.taas.driver.R.id.lv_car_model);
                    ...
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.no_car_model_found), Toast.LENGTH_SHORT).show();
                }
        ...
        ll_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_name), Toast.LENGTH_SHORT).show();
                } else if (email.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_email), Toast.LENGTH_SHORT).show();
                } else if (password.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_password), Toast.LENGTH_SHORT).show();
                } else if (car_id.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_select_car_type), Toast.LENGTH_SHORT).show();
                } else if (car_model_id.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_select_car_model), Toast.LENGTH_SHORT).show();
                } else if (carNumber.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_car_number), Toast.LENGTH_SHORT).show();
                } else if (!(email.matches(emailPattern))) {
                    edt_email_signup.setText("");
                    Toast.makeText(getApplicationContext(), RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_correct_email), Toast.LENGTH_SHORT).show();
                } else if (password.length() < 6) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.password_should_be_minimum_six_digit), Toast.LENGTH_SHORT).show();
                } else if (bank_name.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_bank_name), Toast.LENGTH_SHORT).show();
                } else if (account_number.equals("")) {
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_account_number), Toast.LENGTH_SHORT).show();
                }else if (account_name.equals("")){
                    Toast.makeText(RegisterActivity.this, RegisterActivity.this.getResources().getString(com.taas.driver.R.string.please_enter_account_name), Toast.LENGTH_SHORT).show();
                }else if (imagePathCompressed.equals("")){
                    Toast.makeText(RegisterActivity.this, com.taas.driver.R.string.please_upload_a_good_quality_image_for_your_profile, Toast.LENGTH_SHORT).show();
                }else {
    ...
    public void cameraTask()throws Exception {
        if (EasyPermissions.hasPermissions(this, android.Manifest.permission.CAMERA)) {
            ...
            EasyPermissions.requestPermissions(this, getString(com.taas.driver.R.string.rationale_camera), RC_CAMERA_PERM, android.Manifest.permission.CAMERA);
        }
    }
