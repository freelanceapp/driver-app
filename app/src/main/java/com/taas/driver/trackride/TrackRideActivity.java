package com.taas.driver.trackride;
...
import com.taas.driver.ChatActivity;
import com.taas.driver.Config;
import com.taas.driver.LocationEvent;
import com.taas.driver.LocationSession;
import com.taas.driver.PriceFareActivity;
import com.taas.driver.R;
import com.taas.driver.RideSessionActiveRideEvent;
import com.taas.driver.SelectedRidesActivity;
import com.taas.driver.SosActivity;
import com.taas.driver.SplashActivity;
import com.taas.driver.TripHistoryActivity;
...
import com.taas.driver.models.cancelreasoncustomer.CancelReasonCustomer;
import com.taas.driver.models.restmodels.NewChangeDropLocationModel;
import com.taas.driver.models.restmodels.NewUpdateLatLongModel;
import com.taas.driver.models.ridearrived.RideArrived;
import com.taas.driver.models.viewrideinfodriver.ViewRideInfoDriver;
import com.taas.driver.others.ChatModel;
import com.taas.driver.others.Constants;
import com.taas.driver.others.FirebaseChatEvent;
import com.taas.driver.others.FirebaseChatUtillistener;
import com.taas.driver.others.Maputils;
import com.taas.driver.others.RideSessionEvent;
import com.taas.driver.routedrawer.DrawMarker;
import com.taas.driver.routedrawer.DrawRouteMaps;
import com.taas.driver.samwork.ApiManager;
import com.taas.driver.urls.Apis;
import com.taas.driver.views.MButton;
import com.taas.driver.views.MaterialRippleLayout;
...
//        trip_status_txt.setTextSize(15);
        ...
        bottomLocationLayout = findViewById(R.id.bottomLocationLayout);
        location_text_copy = findViewById(R.id.location_text_copy);
        ...
        findViewById(R.id.pencil_icon).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void setviewAccordingToStatus() {
        ...
        try {
            ...
            if (rideSession.getCurrentRideDetails().get(RideSession.RIDE_STATUS).equals("5")) {
                trip_status_txt.setBackground(getResources().getDrawable(R.drawable.round_bg_color_green));
                trip_status_txt.setTextColor(getResources().getColor(R.color.pure_black));
        ...
        try {
            ...
            if (result_check.result.equals("1")) {
                ...
                if (APINAME.equals("" + Config.ApiKeys.KEY_VIEW_RIDE_INFO_DRIVER)) {
                    ...
                    Picasso.with(this).load(viewRideInfoDriver.getDetails().getUser_image()).into(userImage);
                 }
