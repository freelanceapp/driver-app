...
import com.taas.driver.models.ModelAppVersion;
import com.taas.driver.models.register.Register;
import com.taas.driver.others.AppUtils;
...
public class SplashActivity extends BaseInternetCheckActivity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.taas.driver.R.id.register_btn)
    LinearLayout registerBtn;
    @Bind(com.taas.driver.R.id.login_btn)
    LinearLayout loginBtn;
    @Bind(com.taas.driver.R.id.LoginBox)
    LinearLayout LoginBox;
    @Bind(com.taas.driver.R.id.loading_text)
    TextView loadingText;
    @Bind(com.taas.driver.R.id.demo_login)
    CardView demoLogin;
    ...
    private void showDemoUserDialog() {
        ...
        dialog.setContentView(com.taas.driver.R.layout.demo_driver_dialog);
        dialog.setCancelable(false);

        final EditText demo_name = (EditText) dialog.findViewById(com.taas.driver.R.id.demo_name);
        final EditText demo_phone_email = (EditText) dialog.findViewById(com.taas.driver.R.id.demo_phone_email);

        dialog.findViewById(com.taas.driver.R.id.back_close).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
            }
        ...
        dialog.findViewById(com.taas.driver.R.id.skip).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void checkForVersionUpdation() {
        ...
        try {
            if (!appVersionName.equals(modelAppVersion.getDetails().getAndroid_driver_current_version()) && modelAppVersion.getDetails().getAndroid_driver_mandantory_update().contains("1")) {
                ...
                loadingText.setText(com.taas.driver.R.string.some_man_datory_is_available);
                ...
                loadingText.setText(com.taas.driver.R.string.non_mandatory_update);
                ...
                loadingText.setText(com.taas.driver.R.string.app_is_up_to_date);
...
// ...Irrelevant code for customizing the buttons and title
            ...
            View dialogView = inflater.inflate(com.taas.driver.R.layout.layout_open_location, null);
            dialogBuilder.setView(dialogView);
            final AlertDialog alertDialog = dialogBuilder.create();
            LinearLayout openLocationSettingBtn = (LinearLayout) dialogView.findViewById(com.taas.driver.R.id.openLocationSettingBtn);
            openLocationSettingBtn.setOnClickListener(new View.OnClickListener() {
               @Override
               public void onClick(View view) {
...
//                    }).setCancelable(false).show();
    ...
    private void showInternetDialog() {
        new CFAlertDialog.Builder(this)
                ...
                .setTitle(com.taas.driver.R.string.no_internet_connectivity)
                .setHeaderView(com.taas.driver.R.layout.dialog_header_no_internet)
                .setMessage(com.taas.driver.R.string.it_seems_you_are_out_of_internet_connection)
                .addButton(SplashActivity.this.getString(com.taas.driver.R.string.retry), -1, -1, CFAlertDialog.CFAlertActionStyle.DEFAULT, CFAlertDialog.CFAlertActionAlignment.END, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    private void showUpdationDialog(final boolean is_maindatory) {
        if (!is_version_dialog_is_shown) {
            ...
            dialog.setMessage(com.taas.driver.R.string.new_version_is_avaiable);
            dialog.setCancelable(false);
            dialog.setPositiveButton(com.taas.driver.R.string.ok, new DialogInterface.OnClickListener() {
                @Override
            ...
            if (!is_maindatory) {
                dialog.setNegativeButton(com.taas.driver.R.string.do_it_later, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                        is_version_dialog_is_shown = false;
                        startCheckingLoginProcedure();
    ...
    private void showAppmaintainanceDialog() {
        final AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        dialog.setMessage(com.taas.driver.R.string.your_app_is_in_maintainance);
        dialog.setCancelable(false);
        dialog.setPositiveButton(com.taas.driver.R.string.ok, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface paramDialogInterface, int paramInt) {
    ...
    public void onAPIRunningState(int a, String APINAME) {
        ...
        if (a == ApiManager.APIFETCHER.KEY_API_IS_STARTED) {
            loadingText.setText(com.taas.driver.R.string.fetching_versions);
        } else {
            loadingText.setText(com.taas.driver.R.string.checking_new_versions);
        }
    }
    ...
    private void createDriverSession(Register register) {
        if(register.getDetails().getDetail_status().equals("1")){
            Toast.makeText(splash, "Document of taasdriver not register", Toast.LENGTH_SHORT).show();
