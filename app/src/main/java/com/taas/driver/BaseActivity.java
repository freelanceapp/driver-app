...
import com.taas.driver.others.NoInterNetDialogFragment;
import com.taas.driver.others.NoInterNetDialogFragment;
...
public abstract  class BaseActivity extends FragmentActivity implements NoInterNetDialogFragment.InternetDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.taas.driver.R.layout.activity_base);
    ...
    private boolean checkGPSisOnOrNot(){
        ...
        if(!gps_enabled && !network_enabled) {
            ...
            //dialog.setView(R.layout.layout_open_location);
            dialog.setMessage(com.taas.driver.R.string.enable_app_location);
            dialog.setPositiveButton(com.taas.driver.R.string.open_location_settings, new DialogInterface.OnClickListener() {
                @Override
            ...
            dialog.setNegativeButton(com.taas.driver.R.string.cancel, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                    finish();
                }
