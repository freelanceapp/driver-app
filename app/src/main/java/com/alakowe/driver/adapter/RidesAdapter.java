package com.alakowe.driver.adapter;
...
import com.alakowe.driver.models.viewrides.ViewRides;
...
public class RidesAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (viewRides.getMsg().get(position).getRideStatus().toString().equals("2")) {
            ...
            holder.tv_status.setText(""+context.getResources().getString(R.string.currency_symbol) + viewRides.getMsg().get(position).getTotal_amount());
            holder.tv_pickup_addresss.setText(viewRides.getMsg().get(position).getBeginLocation().trim());
