package com.alakowe.driver.urls;
...
public interface Apis {
    ...
    String change_drop_location = baseDomain+"change_drop_location.php?";  //  drop_lat  drop_long  drop_location  app_id (1 for user and 2 for driver) ride_id
    String heatmap = baseDomain+"heatmap.php?driver_id=";

    String RideSync = restdomain+"/Rental/Ride_Sync";   //  rental_booking_id      app_id= 2 for driver and 1 for cutomer
    ...
    String CustomerSupport = restdomain+"/Common/Customer_support";  //  application(1 for user and 2 for driver)  name  email  phone  query  driver_id  user_id
    ...
    String Notifications = restdomain+"/Common/Notification"; // application  (1 for user and 2 for driver)
