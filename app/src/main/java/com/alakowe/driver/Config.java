...
public class Config {
    ...
    public static String Accept_Receiver = "com.alakowe.driver";
...
//////////////////////////// config attributes
    ...
    public interface Status{
        ...
        String VAL_3 = "3";  // accepted by driver
        String VAL_4 = "4";  // Ride cancelled by driver and trying to alloting to other
        String VAL_5 = "5";  // driver arrived on door
        String VAL_6 = "6";  //  Ride started
        String VAL_7 = "7";  ///  ride ended by driver
        String VAL_8 = "8";  // when user booked ride for later
        String VAL_9 = "9";  // ride cancelled by driver
        ...
        String RENTAL_RIDE_CANCELLED_BY_DRIVER = "18";  // rental ride end by driver
